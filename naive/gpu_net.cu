...
void GPU_Net::train(host_vector< host_vector<float> >& Xtrain, host_vector<int>& Ytrain)
{
...
void GPU_Net::test(host_vector< host_vector<float> >& Xtest, host_vector<int>& Ytest)
{
	dim3 threadsPerBlock(TILE_WIDTH,TILE_WIDTH);
