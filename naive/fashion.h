...
public:
	GPU_Net();
	~GPU_Net();
	virtual void train(host_vector< host_vector<float> >& Xtrain, host_vector<int>& Ytrain);
	virtual void test(host_vector< host_vector<float> >& Xtest, host_vector<int>& Ytest);
